        ...
        <ScrollView contentContainerStyle={styles.content} onScrollEndDrag={reload}>
          ...
          <View style={[styles.card, { marginTop: 20 }]}>
            <View style={styles.cardHead}>
              <Wallet size={26} color={'rgba(0, 40, 74, 1)'} strokeWidth={1.8} style={styles.cardIcon} />
              <Text style={styles.cardTitle}>Cuenta</Text>
              <ChevronDown size={24} color={'rgba(0, 40, 74, 1)'} strokeWidth={1.8} style={styles.cardChevron} />
            </View>
            <View style={styles.divider} />

            <Text style={styles.cardBalance}>{formatMoney(cardBalance)}</Text>
          ...
          <View style={[styles.card, { marginTop: 26 }]}>
            <View style={styles.cardHead}>
              <PiggyBank size={26} color={'rgba(0, 40, 74, 1)'} strokeWidth={1.8} style={styles.cardIcon} />
